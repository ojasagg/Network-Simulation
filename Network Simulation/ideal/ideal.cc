...
/*	Install TCP Receiver on the access point */
        PacketSinkHelper sinkHelper ("ns3::TcpSocketFactory", InetSocketAddress (Ipv4Address::GetAny (), 21));
...
/*
	...
	anim.SetConstantPosition (p2p.Get(0), 1.0, 2.0);
...
//	Simulator::Stops at "second 10".
		Ipv4FlowClassifier::FiveTuple t = classifier->FindFlow (i->first);
	      	if ((t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.1")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.2")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.3")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.4")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.5")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.6")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.7")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.8")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.9")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.10")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.11")||(t.sourceAddress=="10.0.2.2" && t.destinationAddress == "10.0.1.12"))
      		{
